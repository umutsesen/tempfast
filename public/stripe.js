...
delete window.MiniGl; // remove global object property
delete window.Gradient; // remove global object property
console.log(typeof window.MiniGl); // undefined
...
gradient.initGradient("#gradient-canvaslogin");
